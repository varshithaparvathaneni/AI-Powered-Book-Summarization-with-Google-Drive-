...
TARGET_FOLDER_ID = os.getenv("1RcXXkCrzOYiK9Ju6ZeXUI9Q2O9l1QSLe") # Replace with your service account file
...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        flash("✅ File uploaded successfully to Drive! Summary will be generated soon.")
